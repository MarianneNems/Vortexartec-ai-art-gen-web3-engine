...
public function enqueue_styles() {
     ...
     * defined in Vortex_AI_Marketplace_Loader as all of the hooks are defined
     * in that particular class.
     *
     * The Vortex_AI_Marketplace_Loader will then create the relationship
     * between the defined hooks and the functions defined in this
     * class.
     */

    wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/vortex-ai-marketplace-admin.css', array(), $this->version, 'all' );
    
    // Enqueue CLOE dashboard widgets CSS
    wp_enqueue_style( 'vortex-admin', plugin_dir_url( dirname( __FILE__ ) ) . 'css/vortex-admin.css', array(), $this->version, 'all' );
} 