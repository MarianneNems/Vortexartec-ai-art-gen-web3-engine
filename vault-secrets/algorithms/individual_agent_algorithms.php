<?php
/**
 * Individual Shortcodes for HURAII Tabs
 * Each tab gets its own shortcode with complete orchestration pipeline
 * 
 * Shortcodes:
 * - [huraii_generate] - AI art generation
 * - [huraii_describe] - AI image/idea description with CHLOE
 * - [huraii_upscale] - Image upscaling
 * - [huraii_enhance] - Image enhancement
 * - [huraii_export] - Export functionality
 * - [huraii_share] - Social sharing
 * - [huraii_upload] - File upload
 * - [huraii_save] - Save to collections
 * - [huraii_delete] - Delete management
 * - [huraii_edit] - AI-powered editing
 * - [huraii_regenerate] - Regenerate variations
 * - [huraii_vary] - Create variations
 * - [huraii_download] - Download functionality
 *
    ...
    public function handle_individual_generate() {
        ...
        try {
            ...
            if ($this->enhanced_orchestrator) {
                ...
                $result = ['message' => 'Enhanced orchestrator not available'];
            }
